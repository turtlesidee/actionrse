...
import list_question from "./queries/list-question"
import React, { FC } from "react"


type MaturityAssessmentProps = {
  mission_id: number,
...
const MaturityAssessment: FC<MaturityAssessmentProps> = ({ mission_id, update_mission_step}) => {
  const [currentQuestion, setCurrentQuestion] = React.useState(0)
  const [questions] = useQuery(list_question, null);
